...
echo ""
iptables -nvx -L FORWARD | grep DOWNLOAD | awk 'NR==FNR{a[$3]=$4}NR>FNR{if($2>0)print $2/1024/1" KB/s ",$1/10" packets/s", a[$9], $9}' /tmp/dhcp.leases - | sort -n -r
echo ""
echo "Active Uploading Terminals:"
echo ""
iptables -nvx -L FORWARD | grep UPLOAD | awk 'NR==FNR{a[$3]=$4}NR>FNR{if($2>0)print $2/1024/1" KB/s ",$1/10" packets/s", a[$8], $8}' /tmp/dhcp.leases - | sort -n -r
